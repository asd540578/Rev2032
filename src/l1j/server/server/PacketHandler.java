...
import static l1j.server.server.Opcodes.C_OPCODE_BOARDNEXT;//TODO 修正無法使用指令的錯誤封包
...
import static l1j.server.server.Opcodes.C_OPCODE_CALL;//TODO 要求召喚到身邊(GM)
...
import static l1j.server.server.Opcodes.C_OPCODE_ENTERPORTAL;//TODO 3.5C要求傳送 (進入地監)封包修正by99團隊
...
import static l1j.server.server.Opcodes.C_OPCODE_PARTYLIST;//TODO 查看隊伍封包修正
...
import static l1j.server.server.Opcodes.C_OPCODE_RANK;//TODO 請求給予角色血盟階級
import static l1j.server.server.Opcodes.C_OPCODE_RESTART;
import static l1j.server.server.Opcodes.C_OPCODE_RESULT;
import static l1j.server.server.Opcodes.C_OPCODE_RETURNTOLOGIN;//TODO 要求回到選人畫面
import static l1j.server.server.Opcodes.C_OPCODE_SELECTLIST;//TODO 請求修理道具
import static l1j.server.server.Opcodes.C_OPCODE_SELECTTARGET;
import static l1j.server.server.Opcodes.C_OPCODE_SENDLOCATION;//TODO 要求傳送位置(3.3C 新增)封包修正
...
public class PacketHandler {
	...
	public void handlePacket(byte abyte0[], L1PcInstance object)
		...
		case C_OPCODE_BOARDNEXT://TODO 修正無法使用指令的錯誤封包
		...
		case C_OPCODE_RETURNTOLOGIN://TODO 要求回到選人畫面
		...
		case C_OPCODE_PARTYLIST://TODO 查看隊伍封包修正
		...
		case C_OPCODE_ENTERPORTAL://TODO 3.5C要求傳送 (進入地監)封包修正by99團隊
		...
		case C_OPCODE_SELECTLIST://TODO 請求修理道具
		...
		case C_OPCODE_CALL://TODO 要求召喚到身邊(GM)
		...
		case C_OPCODE_RANK://TODO 請求給予角色血盟階級
