...
public class L1ChangeDropAdena implements L1CommandExecutor {
	private static Logger _log = Logger.getLogger(L1ChangeDropAdena.class.getName());
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			if (arg1 != null && !arg1.equals("")) {
				...
				L1World.getInstance().broadcastServerMessage("系統公告" + ": " + "金幣倍率已調整為" + "【"+ Config.RATE_DROP_ADENA + " 】" + "倍" + "。");
				pc.sendPackets(new S_SystemMessage("金幣倍率已調整為" + "【"+ Config.RATE_DROP_ADENA + " 】" + "倍" + "。"));
			} else {
				pc.sendPackets(new S_SystemMessage("目前的金幣倍率為" + "【"+ Config.RATE_DROP_ADENA + " 】" + "倍" + "。"));
			}
		} catch (Exception e) {
			pc.sendPackets(new S_SystemMessage("請輸入『.金幣倍率』。"));
		}
	}
}
