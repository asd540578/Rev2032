...
public class L1ChangeRateLawful implements L1CommandExecutor {
	private static Logger _log = Logger.getLogger(L1ChangeRateLawful.class.getName());
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			if (arg1 != null && !arg1.equals("")) {
				...
				L1World.getInstance().broadcastServerMessage("系統公告" + ": " + "正義值倍率已調整為" + "【"+ Config.RATE_LA + " 】" + "倍" + "。");
				pc.sendPackets(new S_SystemMessage("正義值倍率已調整為" + "【"+ Config.RATE_LA + " 】" + "倍" + "。"));
			} else {
				pc.sendPackets(new S_SystemMessage("目前的正義值倍率為" + "【"+ Config.RATE_LA + " 】" + "倍" + "。"));
			}
		} catch (Exception e) {
			pc.sendPackets(new S_SystemMessage("請輸入『.正義值倍率』。"));
		}
	}
}
