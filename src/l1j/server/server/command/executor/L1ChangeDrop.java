	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			if (arg1 != null && !arg1.equals("")) {
				...
				L1World.getInstance().broadcastServerMessage("系統公告" + ": " + "掉寶率已調整為" + "【"+ Config.RATE_DROP_ITEMS + " 】" + "倍" + "。");
				pc.sendPackets(new S_SystemMessage("掉寶率已調整為" + "【"+ Config.RATE_DROP_ITEMS + " 】" + "倍" + "。"));
			} else {
				pc.sendPackets(new S_SystemMessage("目前的掉寶率為" + "【"+ Config.RATE_DROP_ITEMS + " 】" + "倍" + "。"));
			}
		} catch (Exception e) {
			pc.sendPackets(new S_SystemMessage("請輸入『.掉寶倍率』。"));
		}
	}
}
