...
public class L1PcInstance extends L1Character {
	...
	public void startHpRegenerationByDoll() {
		...
		final int INTERVAL_BY_DOLL = L1MagicDoll.getDollHprTime(this) * 1000;
		boolean isExistHprDoll = false;
		if (L1MagicDoll.getDollHprTime(this) > 0 && L1MagicDoll.getHpByDoll(this) != 0) {
			isExistHprDoll = true;
		}
		//TODO 魔法娃娃額外回血功能改寫DB控制秒數定義
	...
	public void startMpRegenerationByDoll() {
		...
		final int INTERVAL_BY_DOLL = L1MagicDoll.getDollMprTime(this) * 1000;
		boolean isExistMprDoll = false;
		if (L1MagicDoll.getDollMprTime(this) > 0 && L1MagicDoll.getMpByDoll(this) != 0) {
			isExistMprDoll = true;
		}
		//TODO 魔法娃娃額外回魔功能改寫DB控制秒數定義
	...
	private ItemMakeByDoll _itemMakeByDoll;//TODO 魔法娃娃DB化
	private boolean _ItemMakeActiveByDoll;//TODO 魔法娃娃DB化
	...
	private void levelUp(int gap) {
		...
		if (getLevel() >= 51 && getLevel() - 50 > getBonusStats()) {
			if ((getBaseStr() + getBaseDex() + getBaseCon() + getBaseInt()
					+ getBaseWis() + getBaseCha()) < (Config.BONUS_STATS1 * 6)) {//TODO 調整能力值上限
