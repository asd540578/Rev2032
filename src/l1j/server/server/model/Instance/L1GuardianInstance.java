...
import l1j.server.server.datatables.ItemTable;//TODO 守護神給道具順序by seroidv
import l1j.server.server.templates.L1Item;//TODO 守護神給道具順序by seroidv
public class L1GuardianInstance extends L1NpcInstance {
	...
	private int _configtime = Config.GDROPITEM_TIME;//TODO 修正守護神給道具順序by seroidv
			...
			if (attack.calcHit()) {
				try {
					...
					L1Item item40519 = ItemTable.getInstance().getTemplate(
							40519);
					if (npcId == 70848) { //TODO 安特
						if (_inventory.checkItem(40499)
								&& !_inventory.checkItem(40505)) { //TODO 蘑菇汁 換安特之樹皮
						...
						if (_inventory.checkItem(40505)) { //TODO 安特之樹皮
							...
							if (chance <= 60 && chance >= 50) {
								...
								&& !_inventory.checkItem(40505)) { //TODO 安特之樹枝
							chance = _random.nextInt(100) + 1;
							if (chance <= 40 && chance >= 25) {
								...
								&& !_inventory.checkItem(40507)) { //TODO 安特的水果
							chance = _random.nextInt(100) + 1;
					...
					if (npcId == 70850) { //TODO 潘
						if (_inventory.checkItem(40519)) { //TODO 潘的鬃毛
							chance = _random.nextInt(100) + 1;
							if (chance <= 25) {
					...
					if (npcId == 70846) { //TODO 芮克妮
						if (_inventory.checkItem(40507)) { //TODO 安特之樹枝 換 芮克妮的網
