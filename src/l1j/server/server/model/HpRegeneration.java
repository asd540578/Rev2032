...
import l1j.server.Config;//TODO 可設定盟屋、旅館回血回魔量
import l1j.server.server.model.Instance.L1EffectInstance;
import l1j.server.server.model.Instance.L1PcInstance;
import l1j.server.server.serverpackets.S_bonusstats;//TODO 免登出可以把能力值點完by chinaabc
...
public class HpRegeneration extends TimerTask {
	...
	public void regenHp() {
		...
		if (_pc.getMapId() == 16384 || _pc.getMapId() == 16896
				...
				|| _pc.getMapId() == 24576 || _pc.getMapId() == 25088) { //TODO 宿屋
			//bonus += 5;
