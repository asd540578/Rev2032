...
import l1j.server.Config;//TODO 新增在線一段時間給物品
import l1j.server.server.model.L1World;//TODO 新增在線一段時間給物品
import l1j.server.server.model.L1Inventory;//TODO 新增在線一段時間給物品
...
import l1j.server.server.model.Instance.L1ItemInstance;//TODO 新增在線一段時間給物品
import l1j.server.server.datatables.ItemTable;//TODO 新增在線一段時間給物品
...
class L1SkillStop {
	...
	public static void stopSkill(L1Character cha, int skillId) {
		...
		//TODO 暗影閃避 鏡像byajackk2001
		else if (skillId == MIRROR_IMAGE || skillId == UNCANNY_DODGE) { //TODO 鏡像、暗影閃避
			if (cha instanceof L1PcInstance) {
				L1PcInstance pc = (L1PcInstance) cha;
