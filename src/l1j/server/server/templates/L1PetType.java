...
public class L1PetType {
	...
	private final int _evolvItemId;//TODO 寵物進化必須物品DB化
	...
	public L1PetType(int baseNpcId, String name, int itemIdForTaming,
			IntRange hpUpRange, IntRange mpUpRange, int evolvItemId, int 
			npcIdForEvolving,//TODO 寵物進化必須物品DB化
		...
		_evolvItemId = evolvItemId;//TODO 寵物進化必須物品DB化
