...
import l1j.server.server.model.Instance.L1DollInstance;//TODO 魔法娃娃使用判斷 
...
public class C_GiveItem extends ClientBasePacket {
	...
	public C_GiveItem(byte decrypt[], ClientThread client) {
		...
		if (item.getItemId() == petType.getEvolvItemId() && petType.canEvolve()) {//TODO 寵物進化必須物品DB化
			evolvePet(pc, target);
		}
	}
